...
VALUES (293, 0, '[{"dx":-4,"dy":-3,"id":2188},{"dx":-4,"dy":-4,"id":2189},{"dx":-4,"dy":-7,"id":2190},{"dx":-3,"dy":-6,"id":2191}]')
...
VALUES (423, CONVERT(0x54C3B363204A696E6265 USING utf8mb4), 0, -1, CONVERT(0x4B69E1BB83752074C3B363204A696E6265 USING utf8mb4), 1, 2188, 293, 0, 100000, 0, '[]')
ON DUPLICATE KEY UPDATE
    `name` = VALUES(`name`),
    `type` = VALUES(`type`),
...
ALTER TABLE `sprite_images` AUTO_INCREMENT = 2193;
COMMIT;
